...
class ControllerCatalogNotFoundReport extends Controller {
	...
	public function index() {   
		...
		$this->data['action'] = $this->url->link('catalog/not_found_report', 'token=' . $this->session->data['token'], 'SSL');
		...
		$results = $this->model_catalog_not_found_report->getPages($data);
		...
		$this->template = 'catalog/not_found_report.tpl';
		$this->children = array(
			'common/header',
			'common/footer'
		);
