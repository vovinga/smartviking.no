<?php
	...
	$export_html .="<tr>";
	$export_html .= "<td colspan='3' align='center'>".$this->language->get('text_report_date').": ".date($this->config->get('advpp' . $this->user->getId() . '_hour_format') == '24' ? "Y-m-d H:i:s" : "Y-m-d h:i:s A")."</td><td></td>";
	$export_html .="<tr>";
	$export_html .= "<td colspan='3' align='center' style='height:50px; font-size:24; font-weight:bold;'>".$this->language->get('heading_title')."</td><td width='1%' align='left' valign='top' nowrap='nowrap'><b>".$this->config->get('config_name')."</b> <br>".$this->config->get('config_address')." <br>".$this->language->get('text_email')."".$this->config->get('config_email')." <br>".$this->language->get('text_telephone')."".$this->config->get('config_telephone')." </td>";
	$export_html .="<tr>";
	...
	$export_html .= "<td colspan='2' align='left' valign='top'>".$filter_criteria."</td><td></td>";
	$export_html .="<tr>";
	$export_html .="</table>";
	}	
	...
	in_array('mv_price', $advpp_settings_mv_columns) ? $export_html .= "<td align='right' nowrap='nowrap'>".$result['price']."</td>" : '';
	in_array('mv_viewed', $advpp_settings_mv_columns) ? $export_html .= "<td align='right'>".$result['viewed']."</td>" : '';
	in_array('mv_stock_quantity', $advpp_settings_mv_columns) ? $export_html .= "<td align='right'>".$result['stock_quantity']."</td>" : '';
	} elseif ($filter_report == 'manufacturers') {
	in_array('mv_manufacturer', $advpp_settings_mv_columns) ? $export_html .= "<td align='left' style='color:#03C;'><strong>".$result['manufacturers']."</strong></td>" : '';
	} elseif ($filter_report == 'categories') {
	in_array('mv_category', $advpp_settings_mv_columns) ? $export_html .= "<td align='left' style='color:#03C;'><strong>".$result['categories']."</strong></td>" : '';
	}				
	if ($filter_report != 'products_without_orders') {
	...
	in_array('mv_sold_percent', $advpp_settings_mv_columns) ? $export_html .= "<td align='right' nowrap='nowrap' style='background-color:#FFC;'>".round(100 * ($result['sold_quantity'] / $result['sold_quantity_total']), 2) . '%'."</td>" : '';
	} else {
	in_array('mv_sold_percent', $advpp_settings_mv_columns) ? $export_html .= "<td align='right' nowrap='nowrap' style='background-color:#FFC;'>".'0%'."</td>" : '';
	}	
	...
	in_array('mv_reward_points', $advpp_settings_mv_columns) ? $export_html .= "<td align='right'>".$result['reward_points']."</td>" : '';
	}
	$export_html .="</tr>";
	}
	$export_html .="</tbody>";
	...
	in_array('mv_sku', $advpp_settings_mv_columns) ? $export_html .= "<td style='background-color:#E5E5E5;' style='width:120px;'></td>" : '';
	...
	if ($filter_report != 'products_without_orders') {	
	in_array('mv_sold_quantity', $advpp_settings_mv_columns) ? $export_html .= "<td align='right' nowrap='nowrap' class='total'>".$result['sold_quantity_total']."</td>" : '';
	in_array('mv_sold_percent', $advpp_settings_mv_columns) ? $export_html .= "<td align='right' nowrap='nowrap' class='total'>".$result['sold_percent_total']."</td>" : '';
