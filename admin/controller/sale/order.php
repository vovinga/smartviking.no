...
class ControllerSaleOrder extends Controller {
	...
	public function upload() {
  	...
  	public function invoice() {
		...
		$this->data['text_invoice'] = "FAKTURA";

		$this->data['text_order_id'] = "Ordernr.:";
		$this->data['text_invoice_no'] = "Fakturnr.:";
		$this->data['text_invoice_date'] = $this->language->get('text_invoice_date');
		$this->data['text_date_added'] = "Fakturadato:";
		$this->data['text_telephone'] = "Org.nr. NO 912492680 MVA";
		$this->data['text_fax'] = $this->language->get('text_fax');
		$this->data['text_to'] = "Kjøper";
		$this->data['text_company_id'] = $this->language->get('text_company_id');
		$this->data['text_tax_id'] = $this->language->get('text_tax_id');		
		$this->data['text_ship_to'] = "Leveringsadresse";
		$this->data['text_payment_method'] = "Betalingsmåte:";
		$this->data['text_shipping_method'] = "Leveringsmåte:";

		$this->data['column_product'] = "Produktbeskrivelse";
		$this->data['column_model'] = $this->language->get('column_model');
		$this->data['column_quantity'] = "Antall";
		$this->data['column_price'] = "Enh. Pris";
		$this->data['column_total'] = "Totalt";
		$this->data['column_comment'] = $this->language->get('column_comment');
		...
		foreach ($orders as $order_id) {
			...
			if ($order_info) {
				...
				foreach($total_data as $t=>$k)
				{
					if($k['code'] == 'sub_total')
						$total_data[$t]['title'] = "Sum eks. mva";  
				}
				$this->data['orders'][] = array(
					'order_id'	         => $order_id,
