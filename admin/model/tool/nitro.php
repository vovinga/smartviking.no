...
class ModelToolNitro extends Model {
    ...
    public function setNitroPackModules($settings) {
        ...
        if (!empty($settings['NitroTemp']['ActiveModule']['journal'])) {
            if (file_exists($dir.'nitro_journal.xml_')) {
                rename($dir.'nitro_journal.xml_', $dir.'nitro_journal.xml');
            }
        } else {
            if (file_exists($dir.'nitro_journal.xml')) {
                rename($dir.'nitro_journal.xml', $dir.'nitro_journal.xml_');
            }
        }
