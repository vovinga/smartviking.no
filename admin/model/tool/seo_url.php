<?php
//-----------------------------------------------------
// Seo Url for Opencart v1.5.4 / 1.5.5 / 1.5.6    			
// Modified by villagedefrance                          		
// contact@villagedefrance.net                         		
//-----------------------------------------------------
// ADMIN / MODEL / TOOL VERSION
//-----------------------------------------------------
...
class ModelToolSeoUrl extends Model {
	...
	public function rewrite($link) {
		...
		foreach ($data as $key => $value) {
			if (isset($data['route'])) {
				if (($data['route'] == 'product/product' && $key == 'product_id') || (($data['route'] == 'product/manufacturer/' . $manu_route || $data['route'] == 'product/product') && $key == 'manufacturer_id') || ($data['route'] == 'information/information' && $key == 'information_id') || ($data['route'] == 'information/news' && $key == 'news_id') || ($data['route'] == 'information/faq' && $key == 'faq_id') || ($data['route'] == 'articles/article' && $key == 'article_id')) {
