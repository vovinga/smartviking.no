 ...
 */ (function (a) {
    window.elFinder = function (b, c) {
        ...
        var d = this,
            ...
            l = !0,
            m = !0,
            n = ["enable", "disable", "load", "open", "reload", "select","multiselect", "add", "remove", "change", "dblclick", "getfile", "lockfiles", "unlockfiles", "dragstart", "dragstop"],
            o = {},
            p = "",
            q = {
                path: "",
        ...
        }, a.each(["enable", "disable", "load", "open", "reload", "select","multiselect", "add", "remove", "change", "dblclick", "getfile", "lockfiles", "unlockfiles", "dragstart", "dragstop", "search", "searchend", "viewchange"], function (b, c) {
            d[c] = function () {
                var b = arguments[0];
        ...
        lang: "en",
        cssClass: "",
        commands: ["open","multiupload", "reload", "home", "up", "back", "forward", "getfile", "quicklook", "download", "rm", "duplicate", "rename", "mkdir", "mkfile", "upload", "copy", "cut", "paste", "edit", "extract", "archive", "search", "info", "view", "help", "resize", "sort"],
        commandsOptions: {
            getfile: {
                onlyURL: !0,
                multiple: !1,
        ...
        contextmenu: {
            ...
            files: ["getfile", "|", "open", "quicklook", "|", "download", "|", "copy", "cut", "paste", "duplicate", "|", "rm", "|", "edit", "rename", "resize", "|", "archive","multiupload", "extract", "|", "info"]
        },
