...
<div class="box">
  ...
  <div class="content">
  <div id="tabs" class="htabs"><a href="#tab-data">Redirect Manager</a><a href="#tab-auto">Smart Auto Redirect Log</a><a href="#tab-settings">Settings</a></div>
	...
	<table id="redirect" class="list">
        ...
        <tbody id="route-row<?php echo $route_row; ?>">
          <tr>
            <td><input type="text" name="redirect[<?php echo $route_row; ?>][title]" size="80" value="<?php echo $route['title']; ?>" /></td>
            <td><input type="text" name="redirect[<?php echo $route_row; ?>][url]" size="80" value="<?php echo $route['url']; ?>" /></td>			 
