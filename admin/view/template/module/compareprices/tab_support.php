<div class="row-fluid">
  <div class="span4">
    ...
    <div class=""></div>
    <?php if (empty($data['ComparePrices']['LicensedOn'])): ?>
    ...
    <table class="form notLicensedTable">
      <tr>
        ...
        <label>Please enter your product purchase license code <i class="icon-info-sign"></i></label>
			<input type="text" class="licenseCodeBox" placeholder="License Code e.g. XXXXXX-XXXXXX-XXXXXX-XXXXXX-XXXXXX" style="width: 96%" name="ComparePrices[LicenseCode]" value="<?php echo !empty($data['ComparePrices']['LicenseCode']) ? $data['ComparePrices']['LicenseCode'] : ''?>" />
    ...
    <?php endif; ?>
    <?php if (!empty($data['ComparePrices']['LicensedOn'])): ?>
    <input name="cHRpbWl6YXRpb24ef4fe" type="hidden" value="<?php echo base64_encode(json_encode($data['ComparePrices']['License'])); ?>" />
    <input name="OaXRyb1BhY2sgLSBDb21" type="hidden" value="<?php echo $data['ComparePrices']['LicensedOn']; ?>" />
    <table class="form licensedTable">
      <tr>
        ...
        <td>
			<?php echo $data['ComparePrices']['License']['customerName']; ?>
        </td>
      </tr>
      <tr>
        <td>
        ...
        <td>
			...
			<?php foreach ($data['ComparePrices']['License']['licenseDomainsUsed'] as $domain): ?>
      ...
      <tr>
        ...
        <td>
			<?php echo date("F j, Y",strtotime($data['ComparePrices']['License']['licenseExpireDate'])); ?>
        </td>
      </tr>
      <tr>
  ...
  <div class="span8">
    ...
    <div class="row-fluid">
        <ul class="thumbnails supportThumbs">
          <li class="span4">
            <div class="thumbnail">
              <img data-src="holder.js/300x200" alt="Community support" style="width: 300px;" src="view/image/compareprices/community.png">
          ...
          <li class="span4">
            <div class="thumbnail">
              <img data-src="holder.js/300x200" alt="Ticket support" style="width: 300px;" src="view/image/compareprices/tickets.png">
              <div class="caption" style="text-align:center;padding-top:0px;">
                <h3>Tickets</h3>
                <p>Want to comminicate one-to-one with our tech people? Then open a support ticket.</p>
                <p style="padding-top: 5px;"><a href="http://isenselabs.com/tickets/open/<?php echo base64_encode('Support Request').'/'.base64_encode('98').'/'. base64_encode($_SERVER['SERVER_NAME']); ?>" target="_blank" class="btn btn-large">Open a support ticket</a></p>
              </div>
            </div>
          </li>
          <li class="span4">
            <div class="thumbnail">
              <img data-src="holder.js/300x200" alt="Pre-sale support" style="width: 300px;" src="view/image/compareprices/pre-sale.png">
              <div class="caption" style="text-align:center;padding-top:0px;">
                <h3>Pre-sale</h3>
