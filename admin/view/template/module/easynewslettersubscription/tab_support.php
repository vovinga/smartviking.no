  ...
  <div class="span4">
    ...
    <table class="form notLicensedTable">
      <tr>
        ...
        <label>Please enter your product purchase license code <i class="icon-info-sign"></i></label>
			<input type="text" class="licenseCodeBox" placeholder="License Code e.g. XXXXXX-XXXXXX-XXXXXX-XXXXXX-XXXXXX" style="width: 96%" name="EasyNewsletterSubscription[LicenseCode]" value="<?php echo !empty($data['EasyNewsletterSubscription']['LicenseCode']) ? $data['EasyNewsletterSubscription']['LicenseCode'] : ''?>" />
    ...
    <table class="form licensedTable">
      <tr>
        ...
        <td>
			<?php echo $data['EasyNewsletterSubscription']['License']['customerName']; ?>
        </td>
      </tr>
      <tr>
        <td>
      ...
      <tr>
        ...
        <td>
			<?php echo date("F j, Y",strtotime($data['EasyNewsletterSubscription']['License']['licenseExpireDate'])); ?>
        </td>
      </tr>
      <tr>
  ...
  <div class="span8">
    ...
    <div class="row-fluid">
        <ul class="thumbnails supportThumbs">
          <li class="span4">
            <div class="thumbnail">
              <img data-src="holder.js/300x200" alt="Community support" style="width: 300px;" src="view/image/easynewslettersubscription/community.png">
          ...
          <li class="span4">
            <div class="thumbnail">
              ...
              <div class="caption" style="text-align:center;padding-top:0px;">
                ...
                <p style="padding-top: 5px;"><a href="http://isenselabs.com/tickets/open/<?php echo base64_encode('Support Request').'/'.base64_encode('102').'/'. base64_encode($_SERVER['SERVER_NAME']); ?>" target="_blank" class="btn btn-large">Open a support ticket</a></p>
              </div>
            </div>
          </li>
          <li class="span4">
            <div class="thumbnail">
              <img data-src="holder.js/300x200" alt="Pre-sale support" style="width: 300px;" src="view/image/easynewslettersubscription/pre-sale.png">
              <div class="caption" style="text-align:center;padding-top:0px;">
                <h3>Pre-sale</h3>
