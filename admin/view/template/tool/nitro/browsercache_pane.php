  ...
  <tr>
    ...
    <td>
    	<table class="bcHeaders">
            <tr>
				<td class="checkboxHeader"><input type="checkbox" id="chkPagesCacheControl" name="Nitro[BrowserCache][Headers][Pages][CacheControl]" <?php echo (!empty($nitroData['Nitro']['BrowserCache']['Headers']['Pages']['CacheControl'])) ? 'checked=checked' : ''; ?> /></td>            
				<td class="textHeader">
            ...
            <tr>
				<td class="checkboxHeader"><input type="checkbox" id="chkPagesExpires" name="Nitro[BrowserCache][Headers][Pages][Expires]" <?php echo (!empty($nitroData['Nitro']['BrowserCache']['Headers']['Pages']['Expires'])) ? 'checked=checked' : ''; ?> /></td>            
				<td class="textHeader">
            ...
            <tr>
				<td class="checkboxHeader"><input type="checkbox" id="chkPagesLastModified" name="Nitro[BrowserCache][Headers][Pages][LastModified]" <?php echo (!empty($nitroData['Nitro']['BrowserCache']['Headers']['Pages']['LastModified'])) ? 'checked=checked' : ''; ?> /></td>            
				<td class="textHeader">
            ...
            <!--tr>
				<td class="checkboxHeader"><input type="checkbox" id="chkPagesETag" name="Nitro[BrowserCache][Headers][Pages][ETag]" <?php echo (!empty($nitroData['Nitro']['BrowserCache']['Headers']['Pages']['ETag'])) ? 'checked=checked' : ''; ?> /></td>            
				<td class="textHeader">
