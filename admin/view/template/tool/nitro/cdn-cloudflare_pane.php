<div class="row-fluid">
    ...
    <table class="form cdnpanetable">
      ...
      <!--tr>
        ...
        <td>
         <input type="text" name="Nitro[CDNCloudFlare][Email]" value="<?php echo(!empty($nitroData['Nitro']['CDNCloudFlare']['Email'])) ? $nitroData['Nitro']['CDNCloudFlare']['Email'] : ''?>" />
        </td>
      </tr>
      <tr>
        <td>Your API Key</td>
        <td>
         <input type="text" name="Nitro[CDNCloudFlare][APIKey]" value="<?php echo(!empty($nitroData['Nitro']['CDNCloudFlare']['APIKey'])) ? $nitroData['Nitro']['CDNCloudFlare']['APIKey'] : ''?>" />
        </td>
      </tr-->
    </table>
...
Another great advantage of using CloudFlare is that their platform will also block threats and limit abusive bots and crawlers from wasting your bandwidth and server resources.</p>
        <button class="btn btn-small" type="button" onclick="window.open('https://www.cloudflare.com/sign-up')"><i class="icon-external-link"></i>&nbsp;Sign Up</button>
        or 
        <button class="btn btn-small" type="button" onclick="window.open('https://www.cloudflare.com/login')"><i class="icon-external-link"></i>&nbsp;Login</button> in CloudFlare
        </div>
    </div>
</div>
