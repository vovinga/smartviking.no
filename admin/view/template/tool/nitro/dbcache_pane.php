         	...
         	<div id="dbcache-general" class="tab-pane active">
                <table class="form" style="margin-top:-10px;">
                  <tr>
                    ...
                    <table class="ram_settings memcache_settings form">
                      <tr>
                        ...
                        <td>
                          <input type="text" name="Nitro[DBCache][MemcacheHost]" value="<?php echo(!empty($nitroData['Nitro']['DBCache']['MemcacheHost'])) ? $nitroData['Nitro']['DBCache']['MemcacheHost'] : 'localhost'?>" />
                        </td>
                      </tr>
                      <tr>
                        <td>
                        ...
                        <td>
                          <input type="text" name="Nitro[DBCache][MemcachePort]" value="<?php echo(!empty($nitroData['Nitro']['DBCache']['MemcachePort'])) ? $nitroData['Nitro']['DBCache']['MemcachePort'] : '11211'?>" />
                        </td>
                      </tr>
                    </table>
                    <table class="ram_settings memcached_settings form">
                      <tr>
                        ...
                        <td>
                          <input type="text" name="Nitro[DBCache][MemcachedHost]" value="<?php echo(!empty($nitroData['Nitro']['DBCache']['MemcachedHost'])) ? $nitroData['Nitro']['DBCache']['MemcachedHost'] : 'localhost'?>" />
                        </td>
                      </tr>
                      <tr>
                        <td>
                        ...
                        <td>
                          <input type="text" name="Nitro[DBCache][MemcachedPort]" value="<?php echo(!empty($nitroData['Nitro']['DBCache']['MemcachedPort'])) ? $nitroData['Nitro']['DBCache']['MemcachedPort'] : '11211'?>" />
                        </td>
                      </tr>
                    </table>
                    <table class="ram_settings redis_settings form">
                      <tr>
                        ...
                        <td>
                          <input type="text" name="Nitro[DBCache][RedisHost]" value="<?php echo(!empty($nitroData['Nitro']['DBCache']['RedisHost'])) ? $nitroData['Nitro']['DBCache']['RedisHost'] : 'localhost'?>" />
                        </td>
                      </tr>
                      <tr>
                        <td>
                        ...
                        <td>
                          <input type="text" name="Nitro[DBCache][RedisPort]" value="<?php echo(!empty($nitroData['Nitro']['DBCache']['RedisPort'])) ? $nitroData['Nitro']['DBCache']['RedisPort'] : '6379'?>" />
                        </td>
                      </tr>
                      <tr>
                        <td>
                  ...
                  <tr>
                    ...
                    <td>
                        <input type="text" name="Nitro[DBCache][ExpireTime]" value="<?php echo(!empty($nitroData['Nitro']['DBCache']['ExpireTime'])) ? $nitroData['Nitro']['DBCache']['ExpireTime'] : '86400'?>" />
                    </td>
                  </tr>
                </table> 
            </div>
         	...
         	<div id="dbcache-search" class="tab-pane">
                <table class="form" style="margin-top:-10px;">
                  ...
                  <tr>
                    ...
                    <textarea placeholder="e.g. imac, macbook pro, cheap imac, discounts" style="width:400px; height:180px;" name="Nitro[DBCache][SearchKeywords]"><?php echo(!empty($nitroData['Nitro']['DBCache']['SearchKeywords'])) ? $nitroData['Nitro']['DBCache']['SearchKeywords'] : ''?></textarea>
                    </td>
                  </tr>
                </table> 
            </div>
