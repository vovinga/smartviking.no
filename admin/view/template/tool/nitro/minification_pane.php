<div class="row-fluid">
  <div class="span8">
    ...
    <table class="form minificationtoptable">
      ...
      <tr>
        ...
        <td>
        <select name="Nitro[Mini][AutoExclude]" class="NitroMini">
         	...
         	<div id="mini-css" class="tab-pane active">
                <table class="form minification" style="margin-top:-10px;">
                  ...
                  <tr>
                    ...
                    <td>
                    <select name="Nitro[Mini][MergeCSSMedia]">
                  ...
                  <tr>
                    ...
                    <textarea placeholder="e.g. slideshow.css, each file on a new line" style="width:400px; height:180px;" name="Nitro[Mini][CSSExclude]"><?php echo(!empty($nitroData['Nitro']['Mini']['CSSExclude'])) ? $nitroData['Nitro']['Mini']['CSSExclude'] : ''?></textarea>
                    </td>
                  </tr>
                  <tr>
         	...
         	<div id="mini-javascript" class="tab-pane">
                <table class="form minification" style="margin-top:-10px;">
                  ...
                  <tr>
                    ...
                    <td style="vertical-align:top;">
                    <textarea placeholder="e.g. slideshow.js, each file on a new line" style="width:400px; height:180px;" name="Nitro[Mini][JSExclude]"><?php echo(!empty($nitroData['Nitro']['Mini']['JSExclude'])) ? $nitroData['Nitro']['Mini']['JSExclude'] : ''?></textarea>
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td style="vertical-align:top;">
                    <textarea placeholder="e.g. $('.date, .datetime, .time').bgIframe();" style="width:400px; height:180px;" name="Nitro[Mini][JSExcludeInline]"><?php echo(!empty($nitroData['Nitro']['Mini']['JSExcludeInline'])) ? $nitroData['Nitro']['Mini']['JSExcludeInline'] : ''?></textarea>
                    </td>
                  </tr>
                  <tr>
  ...
  <div class="span4">
    ...
    <div class="box-content" style="min-height: 0;">
      <p>
