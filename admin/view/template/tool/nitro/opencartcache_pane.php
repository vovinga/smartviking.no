<table class="form browserCache">
  ...
  <tr>
    ...
    <td>
		<input type="text" name="Nitro[OpenCartCache][ExpireTime]" value="<?php echo !empty($nitroData['Nitro']['OpenCartCache']['ExpireTime']) ? $nitroData['Nitro']['OpenCartCache']['ExpireTime'] : '3600'?>" />
    </td>
  </tr>
  <tr>
