  ...
  <div class="span7">
    ...
    <table class="form pagecache">
      ...
      <tr>
        ...
        <td>
    		<input name="Nitro[PageCache][ExpireTime]" type="text" value="<?php echo (!empty($nitroData['Nitro']['PageCache']['ExpireTime'])) ? $nitroData['Nitro']['PageCache']['ExpireTime'] : NITRO_PAGECACHE_TIME ?>" />
        </td>
      </tr>
      <tr>
        ...
        <td>
        <select name="Nitro[PageCache][MergeDeviceCache]">
      ...
      <tr>
        ...
        <td>
    		<textarea name="Nitro[PageCache][IgnoredRoutes]" style="width:400px; height:180px;" placeholder="One route per line, e.g. information/sitemap"><?php echo (!empty($nitroData['Nitro']['PageCache']['IgnoredRoutes'])) ? $nitroData['Nitro']['PageCache']['IgnoredRoutes'] : '' ?></textarea>
        </td>
      </tr>
      <tr>
        ...
        <td>
            <textarea name="Nitro[PageCache][SupportedCookies]" style="width:400px; height:180px;" placeholder="One cookie per line, e.g. header_notice*"><?php echo (!empty($nitroData['Nitro']['PageCache']['SupportedCookies'])) ? $nitroData['Nitro']['PageCache']['SupportedCookies'] : '' ?></textarea>
        </td>
      </tr>
      <tr>
