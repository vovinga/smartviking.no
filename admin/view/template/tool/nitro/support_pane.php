  ...
  <div class="span4">
    ...
    <table class="form notLicensedTable">
      <tr>
        ...
        <label>Please enter your product purchase license code <i class="icon-info-sign"></i></label>
			<input type="text" class="licenseCodeBox" placeholder="License Code e.g. XXXXXX-XXXXXX-XXXXXX-XXXXXX-XXXXXX" style="width: 96%" name="Nitro[LicenseCode]" value="<?php echo !empty($nitroData['Nitro']['LicenseCode']) ? $nitroData['Nitro']['LicenseCode'] : ''?>" />
    ...
    <table class="form licensedTable">
      <tr>
        ...
        <td>
			<?php echo $nitroData['Nitro']['License']['customerName']; ?>
        </td>
      </tr>
      <tr>
        <td>
      ...
      <tr>
        ...
        <td>
			<?php echo date("F j, Y",strtotime($nitroData['Nitro']['License']['licenseExpireDate'])); ?>
        </td>
      </tr>
      <tr>
