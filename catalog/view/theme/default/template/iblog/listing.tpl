	...
	<div class="iblog-header">
		<div class="iblog-search">
			<form method="get" action="<?php echo $search_link; ?>"> 
				<p>
					<strong><?php echo $search_string; ?></strong> <input type="text" name="search" value="" class="search-field" placeholder="<?php echo $search_placeholder; ?>"> 
					<input type="submit" value="<?php echo $search_button; ?>" id="button-search" class="button search-button">
				</p>
			</form>
		</div>
