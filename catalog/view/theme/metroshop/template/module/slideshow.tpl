...
<div class="flexslider">
  <ul class="slides">
    ...
    <li>
    <?php if ($banner['link']) { ?>
    <a rel="nofollow" href="<?php echo $banner['link']; ?>"><img src="<?php echo $banner['image']; ?>" alt="<?php echo $banner['title']; ?>" /></a>
    <?php } else { ?>
...
<div class="mini-sliders">
  <?php
    ...
    <?php if ($banner['link']) { ?>
    <a rel="nofollow" href="<?php echo $banner['link']; ?>"><img class="fade-image" src="<?php echo $banner['image']; ?>" alt="<?php echo $banner['title']; ?>"/></a>
    <?php } else { ?>
    <img src="<?php echo $banner['image']; ?>" alt="<?php echo $banner['title']; ?>" />
    <?php } ?>
