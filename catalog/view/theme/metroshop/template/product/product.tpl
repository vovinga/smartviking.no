...
<div style="display:block; width:100%; margin-bottom:10px;">
  ...
  <div class="product-info">
    ...
    <div class="left">
      ...
      <div class="image"><a href="<?php echo $popup; ?>" title="<?php echo $heading_title; ?>" id="zoom01" <? if(($this->config->get('metroshop_status') == '1') && ($this->config->get('metroshop_effects_productimage') == 'zoom')) { echo 'class="cloud-zoom" rel="position:\'right\', zoomWidth:320, zoomHeight:320, adjustX:10, adjustY:0, tint:\'#FFFFFF\', showTitle:false, softFocus:1, smoothMove:5, tintOpacity:0.8"';} else { echo 'rel="prettyPhoto"';} ?>><img width="320" height="320" src="<?php echo $thumb; ?>" title="<?php echo $heading_title; ?>" alt="<?php echo $heading_title; ?>" id="image" /></a></div>
      ...
      <?php if ($images) { ?>
        ...
        <div class="image-additional gallery">
          ...
          <a href="<?php echo $image['popup']; ?>" title="<?php echo $heading_title; ?>" <? if(($this->config->get('metroshop_status') == '1') && ($this->config->get('metroshop_effects_productimage') == 'zoom')) { echo 'rel="useZoom: \'zoom01\', smallImage: \''.$image['zoom_thumb'].'\'" class="cloud-zoom-gallery"';} else { echo 'rel="prettyPhoto[pp_gal]"';} ?>><img class="fade-image" src="<?php echo $image['thumb']; ?>" title="<?php echo $heading_title; ?>" alt="<?php echo $heading_title; ?>" /></a>
          <?php } ?>
          <div class="clear"></div>
        </div>
