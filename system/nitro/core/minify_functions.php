                ...
                case 'js':
                    try {
                        if (!(NITRO_DONT_MINIFY_MINIFIED_RESOURCES && $isMinified)) {
                            $content = nitroMinifyJsCode($content);
                        }
                    } catch (Exception $e) {
                        if (NITRO_DEBUG_MODE) {
