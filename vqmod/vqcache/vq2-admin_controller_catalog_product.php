	...
	private $error = array(); 
  	...
  	public function insert() {
    	...
    	if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->redirect($this->url->link($this->config->get('aqe_status') ? 'catalog/product_ext' : 'catalog/product', 'token=' . $this->session->data['token'] . $url, 'SSL'));
    	}
  	...
  	protected function getList() {				
		...
		if (isset($this->request->get['page'])) {
  		...
  		$this->data['breadcrumbs'] = array();
   		...
   		$this->data['breadcrumbs'][] = array(
			...
			'href'      => $this->url->link($this->config->get('aqe_status') ? 'catalog/product_ext' : 'catalog/product', 'token=' . $this->session->data['token'] . $url, 'SSL'),       		
      		'separator' => ' :: '
   		);
		...
		$this->data['sort_name'] = $this->url->link($this->config->get('aqe_status') ? 'catalog/product_ext' : 'catalog/product', 'token=' . $this->session->data['token'] . '&sort=pd.name' . $url, 'SSL');
		$this->data['sort_model'] = $this->url->link($this->config->get('aqe_status') ? 'catalog/product_ext' : 'catalog/product', 'token=' . $this->session->data['token'] . '&sort=p.model' . $url, 'SSL');
		$this->data['sort_price'] = $this->url->link($this->config->get('aqe_status') ? 'catalog/product_ext' : 'catalog/product', 'token=' . $this->session->data['token'] . '&sort=p.price' . $url, 'SSL');

		$this->data['sort_cost'] = $this->url->link($this->config->get('aqe_status') ? 'catalog/product_ext' : 'catalog/product', 'token=' . $this->session->data['token'] . '&sort=p.cost' . $url, 'SSL');	
            
		$this->data['sort_quantity'] = $this->url->link($this->config->get('aqe_status') ? 'catalog/product_ext' : 'catalog/product', 'token=' . $this->session->data['token'] . '&sort=p.quantity' . $url, 'SSL');
		$this->data['sort_status'] = $this->url->link($this->config->get('aqe_status') ? 'catalog/product_ext' : 'catalog/product', 'token=' . $this->session->data['token'] . '&sort=p.status' . $url, 'SSL');
		$this->data['sort_order'] = $this->url->link($this->config->get('aqe_status') ? 'catalog/product_ext' : 'catalog/product', 'token=' . $this->session->data['token'] . '&sort=p.sort_order' . $url, 'SSL');
		...
		$pagination->url = $this->url->link($this->config->get('aqe_status') ? 'catalog/product_ext' : 'catalog/product', 'token=' . $this->session->data['token'] . $url . '&page={page}', 'SSL');
...
$this->data['entry_custom_h2'] = $this->language->get('entry_custom_h2');
$this->data['entry_custom_imgtitle'] = $this->language->get('entry_custom_imgtitle');
...
if (isset($this->error['custom_h2'])) {
					$this->data['error_custom_h2'] = $this->error['custom_h2'];
				} else {
					$this->data['error_custom_h2'] = array();
				}	
if (isset($this->error['custom_imgtitle'])) {
...
if (isset($this->error['custom_title'])) {
		...
		$this->data['cancel'] = $this->url->link($this->config->get('aqe_status') ? 'catalog/product_ext' : 'catalog/product', 'token=' . $this->session->data['token'] . $url, 'SSL');
