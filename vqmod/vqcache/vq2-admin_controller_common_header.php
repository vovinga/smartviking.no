  ...
  //excel export - start
	...
	//excel export - end
		...
		$this->data['text_product'] = $this->language->get('text_product'); 
			...
			$this->data['text_canonicals'] = $this->language->get('text_canonicals');
			$this->data['text_mlseo'] = $this->language->get('text_mlseo');
			$this->data['text_richsnippets'] = $this->language->get('text_richsnippets');
			$this->data['text_seopagination'] = $this->language->get('text_seopagination');
			$this->data['text_redirect'] = $this->language->get('text_redirect');
			$this->data['text_not_found_report'] = $this->language->get('text_not_found_report');
			$this->data['text_seoreplacer'] = $this->language->get('text_seoreplacer');
			$this->data['text_extendedseo'] = $this->language->get('text_extendedseo');
			$this->data['text_about'] = $this->language->get('text_about');
			$this->data['text_clickfix'] = $this->language->get('text_clickfix');
			$this->data['text_bot_report'] = $this->language->get('text_bot_report');
...
$this->data['text_report_adv_customer_profit'] = $this->language->get('text_report_adv_customer_profit');
		...
		if (!$this->user->isLogged() || !isset($this->request->get['token']) || !isset($this->session->data['token']) || ($this->request->get['token'] != $this->session->data['token'])) {
			...
			$this->data['canonicals'] = $this->url->link('catalog/canonicals', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['mlseo'] = $this->url->link('catalog/mlseo', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['richsnippets'] = $this->url->link('catalog/richsnippets', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['seopagination'] = $this->url->link('catalog/seopagination', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['redirect'] = $this->url->link('catalog/redirect', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['not_found_report'] = $this->url->link('catalog/not_found_report', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['seoreplacer'] = $this->url->link('catalog/seoreplacer', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['extendedseo'] = $this->url->link('catalog/extendedseo', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['clickfix'] = $this->url->link('catalog/clickfix', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['bot_report'] = $this->url->link('catalog/bot_report', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['about'] = $this->url->link('catalog/about', 'token=' . $this->session->data['token'], 'SSL');
