...
$_['entry_custom_h2']            = 'Custom H2:<br/><span class="help">Leave empty if you want the default header to be displayed</span>';
$_['entry_custom_imgtitle']            = 'Custom Image Title Tag:<br/><span class="help">Leave empty if you want the default image title tag to be displayed</span>';
