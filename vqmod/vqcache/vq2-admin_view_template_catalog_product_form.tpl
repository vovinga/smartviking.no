...
<td><?php echo $entry_custom_h1; ?></td>
			<td><input type="text" name="product_description[<?php echo $language['language_id']; ?>][custom_h1]" size="100" value="<?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['custom_h1'] : ''; ?>" /></td>
              ...
              <tr>
<td><?php echo $entry_custom_h2; ?></td>
			<td><input type="text" name="product_description[<?php echo $language['language_id']; ?>][custom_h2]" size="100" value="<?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['custom_h2'] : ''; ?>" /></td>
              </tr>
              <tr>
<td><?php echo $entry_custom_imgtitle; ?></td>
