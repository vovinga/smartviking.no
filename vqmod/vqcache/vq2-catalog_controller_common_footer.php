...
$extendedseo = $this->config->get('extendedseo');
		$this->data['powered'] = sprintf($this->language->get('text_powered'), ((isset($extendedseo['link']))?'<a href="'.$this->config->get('config_url').'">':'').$this->config->get('config_name').'</a>', date('Y', time()));
