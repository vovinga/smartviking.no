...
$extendedseo = $this->config->get('extendedseo');
			($product_info['custom_title'] == '')?$this->document->setTitle(((isset($category_info['name']) && isset($extendedseo['categoryintitle']) )?($category_info['name'].' : '):'').$product_info['name']):$this->document->setTitle($product_info['custom_title']);
...
$this->data['custom_imgtitle'] = $product_info['custom_imgtitle'];
			...
			$extendedseo = $this->config->get('extendedseo');
			$this->data['description'] = ((isset($extendedseo['productseo']))?'<h2>'.$product_info['name'].'</h2>':'').html_entity_decode($product_info['description'], ENT_QUOTES, 'UTF-8');
			
$this->data['description'] = ($product_info['custom_h2'] != '')?'<h2>'.$product_info['custom_h2'].'</h2>'.$this->data['description']:$this->data['description'];
