	...
	public function getProduct($product_id) {
		...
		if ($query->num_rows) {
			...
			/* end - ipl extension - dbassa */
				...
				'meta_keyword'     => $query->row['meta_keyword'], 'custom_title' => $query->row['custom_title'], 'custom_imgtitle' => $query->row['custom_imgtitle'], 'custom_h2' => $query->row['custom_h2'], 'custom_h1' => $query->row['custom_h1'], 'custom_alt' => $query->row['custom_alt'],
				'tag'              => $query->row['tag'],
