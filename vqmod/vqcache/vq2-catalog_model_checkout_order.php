...
class ModelCheckoutOrder extends Model {	
	...
	public function addOrder($data) {
		...
		foreach ($data['products'] as $product) { 
			$this->db->query("INSERT INTO " . DB_PREFIX . "order_product SET order_id = '" . (int)$order_id . "', product_id = '" . (int)$product['product_id'] . "', name = '" . $this->db->escape($product['name']) . "', model = '" . $this->db->escape($product['model']) . "', quantity = '" . (int)$product['quantity'] . "', price = '" . (float)(isset($product['price']) ? $product['price']:0) . "', cost = '" . (float)(isset($product['cost']) ? $product['cost'] : 0 ). "', total = '" . (float)$product['total'] . "', tax = '" . (float)$product['tax'] . "', reward = '" . (int)$product['reward'] . "'");
	...
	public function confirm($order_id, $order_status_id, $comment = '', $notify = false) {
		...
		//deim debug
		//$this->log->write("Отправка письма 1");
		...
		if ($order_info && !$order_info['order_status_id']) {
			...
			//deim debug
			//$this->log->write("Отправка письма 2");
			...
			//deim debug
			//$this->log->write("Отправка письма 3, перед загрузкой языков");
			...
			//deim debug
			//$this->log->write("Отправка письма 4, после загрузки языков");
            ...
            //deim debug
			//$this->log->write("Отправка письма 5, перед амазоном");
