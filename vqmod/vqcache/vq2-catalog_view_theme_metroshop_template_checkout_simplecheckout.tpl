...
<?php } ?>
			...
			<img src="image/data/ga.png" onload="<?php if ($this->config->get('config_ga_tracking_type') == 2) { echo "ga('send', 'pageview', '/simplecheckout');";} else{echo "var _gaq = _gaq || []; _gaq.push(['_trackPageview','/simplecheckout']);"; } ?>">
    ...
    <div class="simplecheckout-button-block buttons" id="step_buttons">
        <div class="simplecheckout-button-right">
            <a rel="nofollow" class="button btn" onclick="simplecheckout_next();" id="simplecheckout_next"><span><?php echo $button_next; ?></span></a>
        </div>
