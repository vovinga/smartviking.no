					...
					if (isset($this->request->get['route'])) {
						if ($this->request->get['route'] == 'product/product') {
							foreach($languages as $xlanguage) {
								...
								echo '<link rel="alternate" hreflang="'.$xlanguage['code'].'" href="'.HTTP_SERVER.$url.'" />';
...
<?php if (($this->config->get('config_ga_cookie') == 1) && (!$this->user->isLogged() || $this->config->get('config_ga_exclude_admin') != 1 && $this->user->isLogged()))  { ?>
...
<?php } ?>
<?php if (($this->config->get('config_ga_tracking_type') == 1) && (!$this->user->isLogged() || $this->config->get('config_ga_exclude_admin') != 1 && $this->user->isLogged()))  { ?>
<?php if (($this->config->get('config_ga_cookie') == 1) && (!$this->user->isLogged() || $this->config->get('config_ga_exclude_admin') != 1 && $this->user->isLogged())) { echo '<script type="text/plain" class="cc-onconsent-analytics">';} else{echo '<script type="text/javascript">'; } ?>

  var _gaq = _gaq || [];
  _gaq.push(['_setAccount', '<?php echo $this->config->get("config_ua_tracking"); ?>']);
  _gaq.push(['_setDomainName', '<?php echo $this->config->get("config_ga_domain"); ?>']);
...
</script><?php } else if (($this->config->get('config_ga_tracking_type') == 2) && (!$this->user->isLogged() || $this->config->get('config_ga_exclude_admin') != 1 && $this->user->isLogged()))  { ?>
<?php if (($this->config->get('config_ga_cookie') == 1) && (!$this->user->isLogged() || $this->config->get('config_ga_exclude_admin') != 1 && $this->user->isLogged())) { echo '<script type="text/plain" class="cc-onconsent-analytics">';} else{echo '<script>'; } ?>
