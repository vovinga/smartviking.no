      ...
      <?php foreach ($products as $product) { ?>
        ...
        <div class="view-first">
          <div class="view-content">  
            ...
            <div class="image"><a href="<?php echo $product['href']; ?>"><!-- star ipl --><?php echo $product['labels']; ?><!-- end ipl --><img src="<?php echo str_replace(' ','%20',$product['thumb']); ?>" alt="<?php echo $product['name']; ?>" /></a></div>
            <?php } ?>
              
            <div class="bottom-block">
              <div class="name"><a rel="nofollow" title="<?php echo $product['name']; ?>" href="<?php echo $product['href']; ?>"><?php mb_internal_encoding("UTF-8"); if(strlen($product['name']) > 23) { $product['name'] = mb_substr($product['name'],0,23).''; } echo $product['name']; ?></a></div>
