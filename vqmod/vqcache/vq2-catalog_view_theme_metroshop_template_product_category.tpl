...
<div id="cat"><H1><?php echo $heading_title; ?></H1></div>
  <?php //foreach ($breadcrumbs as $breadcrumb) { ?>
...
<noindex>
  <div class="product-filter clearfix">
    <div class="display"><b><?php echo $text_display; ?></b> <a rel="nofollow" title="<?php echo $text_list; ?>" class="list-switch active"></a><a rel="nofollow" class="grid-switch" title="<?php echo $text_grid; ?>" onclick="display('grid');"></a><a rel="nofollow" href="<?php echo $compare; ?>" id="compare-total"><?php echo $text_compare; ?></a></div>
      ...
      <div class="box-product-item">
        <div class="view-first">
          <div class="view-content">  
            ...
            <div class="image"><a rel="nofollow" href="<?php echo $product['href']; ?>" title="<?php echo $product['name']; ?>"><!-- star ipl --><?php echo $product['labels']; ?><!-- end ipl --><img src="<?php echo $product['thumb']; ?>" alt="<?php echo $product['name']; ?>" /></a></div>
            <?php } ?>
 ...
 <div class="product-list box-product">
  ...
  <div class="list-product-item">
	  ...
	  <div class="left-block">
	    <?php if ($product['thumb']) { ?>
	    <div class="image"><a rel="nofollow" href="<?php echo $product['href']; ?>" title="<?php echo $product['name']; ?>"><img class="fade-image" src="<?php echo $product['thumb']; ?>" alt="<?php echo $product['name']; ?>" /></a></div>
	    <?php } ?>
	  </div>
	  
	  <div class="center-block">
	    <div class="list-name"><a href="<?php echo $product['href']; ?>" title="<?php echo $product['name']; ?>"><?php echo $product['name']; ?></a></div>
	  ...
	  <div class="right-block">
	    ...
	    <?php } ?>
	    <div class="btn-cart"><a rel="nofollow" class="button" onclick="addToCart('<?php echo $product['product_id']; ?>');"><?php echo $button_cart; ?></a></div>
...
function display(view) {
	if (view == 'list') {
		...
		$('.display').html('<b><?php echo $text_display; ?></b> <a rel="nofollow" title="<?php echo $text_list; ?>" class="list-switch active"></a><a rel="nofollow" class="grid-switch" title="<?php echo $text_grid; ?>" onclick="display(\'grid\');"></a><a rel="nofollow" href="<?php echo $compare; ?>" id="compare-total"><?php echo $text_compare; ?></a>');
		...
		$('.display').html('<b><?php echo $text_display; ?></b> <a rel="nofollow" class="list-switch" title="<?php echo $text_list; ?>" onclick="display(\'list\');"></a><a rel="nofollow" class="grid-switch active" title="<?php echo $text_grid; ?>" ></a><a rel="nofollow" href="<?php echo $compare; ?>" id="compare-total"><?php echo $text_compare; ?></a>');
